...
public static class AccountEndpoints
{
    ...
    public static IEndpointRouteBuilder MapAccountEndpoints(this IEndpointRouteBuilder endpoints)
    {
        ...
        account.MapPost("register", Register);
        account.MapPost("login", Login);
        account.MapGet("logout", Logout);
        ...
        HttpContext context)
    {
        if (!userManager.SupportsUserEmail)
            throw new NotSupportedException($"{nameof(MapAccountEndpoints)} requires a user store with email support.");
    ...
    private static async Task<Results<Ok, EmptyHttpResult, ProblemHttpResult>> Login(
    ...
    private static async Task<Results<Ok, EmptyHttpResult, ProblemHttpResult>> Logout(
        SignInManager<User> signInManager)
    {
    ...
    private static async Task<Results<Ok<UserProfileResponse>, UnauthorizedHttpResult, NotFound>> GetUserProfile(
    ...
    private static async Task<Results<Ok<UserChannelListResponse>, UnauthorizedHttpResult, NotFound>> GetUserChannels(
        ClaimsPrincipal principal,
