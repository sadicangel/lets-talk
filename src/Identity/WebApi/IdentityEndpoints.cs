...
public static class IdentityEndpoints
{
    ...
    private static async Task SendConfirmationEmailAsync(AppUser user, UserManager<AppUser> userManager, HttpContext context, string email, bool isChange = false)
    {
        _ = user;
        _ = userManager;
        _ = context;
